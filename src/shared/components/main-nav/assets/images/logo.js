...
export default class Logo extends Component {
  render() {
    return (
      <svg id="be40ced8-34d6-4a2c-ab88-809b6d89e7fc" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="306" height="134.1" viewBox="0 0 306 134.1">
        <title>CBE-black-logo</title>
        <g>
          ...
          <path class="e2528cc1-e2ed-45d4-8532-45a5fe1df121" d="M851.5,540a14.6,14.6,0,0,0-5.5-8c-2.8-1.9-7.3-1.2-10.5,1.5s-4.5,6.7-3,10,4.2,6.6,9,6.6,7.2-2.7,9-6.6a8.2,8.2,0,0,0,1-3" transform="translate(-793.1 -494.8)"/>
          <path class="e2528cc1-e2ed-45d4-8532-45a5fe1df121" d="M892.5,540.5H852" transform="translate(-793.1 -494.8)"/>
          <path class="e2528cc1-e2ed-45d4-8532-45a5fe1df121" d="M990.5,561.5h-10" transform="translate(-793.1 -494.8)"/>
        </g>
        <text class="e62393f8-8251-4737-ad73-c57bb1818d90" transform="translate(5.5 126.4)">CUSTOM BOW EQUIPMENT</text>
      </svg>
